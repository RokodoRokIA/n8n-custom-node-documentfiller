...
exports.generateCheckboxAnalysisPrompt = generateCheckboxAnalysisPrompt;
exports.parseCheckboxDecisions = parseCheckboxDecisions;
exports.analyzeCheckboxesWithAI = analyzeCheckboxesWithAI;
 ...
 */
function generateCheckboxAnalysisPrompt(templateCheckboxes, targetCheckboxes, templatePairs, documentContext) {
 ...
 */
function parseCheckboxDecisions(response) {
    var _a, _b, _c;
    ...
    try {
        ...
        for (const decision of decisions) {
            ...
            if (validation.valid) {
                validDecisions.push({
                    targetIndex: (_b = (_a = decision.targetIndex) !== null && _a !== void 0 ? _a : decision.targetIdx) !== null && _b !== void 0 ? _b : decision.idx,
                    label: decision.label || '',
                    shouldBeChecked: Boolean((_c = decision.shouldBeChecked) !== null && _c !== void 0 ? _c : decision.checked),
        ...
        console.error('❌ parseCheckboxDecisions: Erreur de parsing:', error.message);
        return [];
    }
}
/**
 ...
 */
function extractCheckboxJSON(response) {
 ...
 */
function validateCheckboxDecision(decision) {
    var _a, _b;
    const idx = (_b = (_a = decision.targetIndex) !== null && _a !== void 0 ? _a : decision.targetIdx) !== null && _b !== void 0 ? _b : decision.idx;
 ...
 */
async function analyzeCheckboxesWithAI(model, targetXml, templateCheckboxes, targetCheckboxes, templatePairs, documentContext, debug = false) {
    ...
    // Générer le prompt
    const prompt = generateCheckboxAnalysisPrompt(templateCheckboxes, targetCheckboxes, templatePairs, documentContext);
    if (debug) {
    ...
    try {
        ...
        const result = (0, checkbox_utils_1.applyCheckboxesToXml)(targetXml, matches);
        return {
            decisions,
        ...
        console.error('❌ Erreur lors de l\'analyse IA des checkboxes:', error.message);
        return fallbackToTemplateCopy(targetXml, templateCheckboxes, targetCheckboxes);
    }
}
/**
 ...
 */
function convertDecisionsToMatches(decisions, targetCheckboxes) {
    const matches = [];
    for (const decision of decisions) {
 ...
 */
function fallbackToTemplateCopy(targetXml, templateCheckboxes, targetCheckboxes) {
 ...
 */
function extractDocumentContext(xml) {
