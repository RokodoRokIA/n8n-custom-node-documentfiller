...
exports.reconstructFragmentedText = reconstructFragmentedText;
exports.validateXml = validateXml;
exports.escapeXml = escapeXml;
exports.isInsideTableCell = isInsideTableCell;
exports.extractParagraphsFromXml = extractParagraphsFromXml;
// ============================================================================
// EXTRACTION DE TEXTE
// ============================================================================
/**
 ...
 */
function reconstructFragmentedText(xml) {
        ...
        if (textElements.length > 1) {
            ...
            for (let i = textElements.length - 1; i >= 0; i--) {
                if (i === 0) {
                    ...
                    newContent = newContent.replace(textElements[i].full, `<w:t${attrs}>${combinedText}</w:t>`);
                }
                else {
 ...
 */
function isInsideTableCell(xml, paragraphStart, paragraphXml) {
