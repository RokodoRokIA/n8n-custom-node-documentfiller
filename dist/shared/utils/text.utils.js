...
exports.TAG_REGEX_SINGLE = exports.TAG_REGEX = void 0;
exports.normalizeText = normalizeText;
exports.hasExistingTag = hasExistingTag;
exports.extractTagNames = extractTagNames;
exports.stripTagBraces = stripTagBraces;
exports.wrapWithBraces = wrapWithBraces;
 ...
 */
exports.TAG_REGEX = /\{\{[A-Z_0-9]+\}\}/g;
/**
 * Expression régulière pour un seul tag (sans flag global).
 */
exports.TAG_REGEX_SINGLE = /\{\{[A-Z_0-9]+\}\}/;
/**
 ...
 */
function hasExistingTag(text) {
    return exports.TAG_REGEX_SINGLE.test(text);
}
/**
...
function extractTagNames(text) {
    const matches = text.match(exports.TAG_REGEX) || [];
 ...
 */
function stripTagBraces(fullTag) {
 ...
 */
function wrapWithBraces(tagName) {
    return `{{${tagName}}}`;
}
// ============================================================================
 ...
 */
function detectSection(text, previousSection) {
